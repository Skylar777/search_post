...
public class ProblemNPuzzle extends Problem {
	...
	public static void main(String[] args) throws Exception {
		...
		ProblemNPuzzle wolfproblem = new ProblemNPuzzle();
		int[][] wolfpuzzleArray = {{0,1}, {0,1}, {0,1}};
		wolfproblem.initialState = new StateNPuzzle(wolfpuzzleArray); 
		...
		ProblemNPuzzle cannibalproblem = new ProblemNPuzzle();
		int[][] cannibalpuzzleArray = {{0,3}, {0,3}};
		cannibalproblem.initialState = new StateNPuzzle(cannibalpuzzleArray); 

		// ProblemNPuzzle pancakeproblem = new ProblemNPuzzle();
		// int[][] pancakepuzzleArray = {{1}, {0}, {3}, {5}, {2}, {4}};
		// pancakeproblem.initialState = new StateNPuzzle(pancakepuzzleArray); 
